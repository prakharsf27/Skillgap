...
import { Lock, ArrowRight, AlertCircle, CheckCircle2, Brain } from "lucide-react";
...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#08080F] text-[#EEEEFF] flex items-center justify-center overflow-hidden font-sans">
      ...
      <div 
        className="absolute inset-0 z-0 bg-cover bg-center opacity-[0.5]" 
      ...
      <div className="max-w-md w-full px-6 relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-white/45 text-xs mt-2 leading-relaxed">
            Please enter your new password configuration rules below.
          </p>
        </div>

        <GlassCard className="p-8" glow="#8B5CF6" style={{ background: "rgba(10, 10, 20, 0.85)" }}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-xl text-sm outline-none border border-white/8 bg-white/4 text-white placeholder:text-white/25 focus:border-[#8B5CF6]/50 focus:ring-2 focus:ring-[#8B5CF6]/20 transition-all"
                />
              </div>
            </div>
